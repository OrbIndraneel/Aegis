 ...
 *
 * Example: A shelter 3.8km away with 44% occupancy is recommended over
 * a closer shelter 1.4km away with 94% occupancy.
 */
export function getLoadBalancedShelterRecommendations(
  ...
  const scoredShelters = shelters.map((shelter) => {
    ...
    // Base score components (lower score is better)
