...
import { getHazardRiskReasons } from '../../utils/riskExplanation';
...
export const HazardCard: React.FC<Props> = ({ hazard, onPress }) => {
  const riskFactors = getHazardRiskReasons(hazard);
  ...
  return (
    <View style={styles.card}>
      ...
      {/* Why Am I At Risk? Accordion */}
      <RiskExplanationAccordion factors={riskFactors} theme="dark" />
