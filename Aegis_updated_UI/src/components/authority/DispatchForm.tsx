...
export const DispatchForm: React.FC = () => {
  ...
  const [disasterType, setDisasterType] = useState<DisasterType>('LANDSLIDE');
  const [title, setTitle] = useState('LANDSLIDE IMMINENT WARNING — NH-10 MILE 20');
  const [body, setBody] = useState('Sikkim SDMA mandates immediate civilian movement to Singtam Relief Camp via Upper Ridge Bypass.');
