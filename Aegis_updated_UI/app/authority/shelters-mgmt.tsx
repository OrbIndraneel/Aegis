  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <ScrollView style={styles.content} showsVerticalScrollIndicator={false}>
        ...
        <Text style={styles.sectionTitle}>SDRF & MOUNTAIN RELIEF SUPPLY DISPATCH</Text>
        <View style={styles.actionRow}>
          <TouchableOpacity style={styles.actionCard} activeOpacity={0.8}>
            <Truck size={18} color={colors.primary.main} />
            <Text style={styles.actionTitle}>Dispatch BRO Dozers</Text>
            <Text style={styles.actionSub}>2 Excavators Standby</Text>
          </TouchableOpacity>

          <TouchableOpacity style={styles.actionCard} activeOpacity={0.8}>
            <Radio size={18} color={colors.safety.main} />
            <Text style={styles.actionTitle}>Deploy SDRF Unit</Text>
            <Text style={styles.actionSub}>2nd Mountain Battalion</Text>
          </TouchableOpacity>
        </View>
        ...
        {shelters.map((shelter) => (
          <View key={shelter.id} style={styles.mgmtWrapper}>
            ...
            <View style={styles.controlBar}>
              <Text style={styles.unitText}>Assigned Staging Unit: {shelter.ndrfUnitId || 'SDRF 2nd Mountain Battalion'}</Text>
