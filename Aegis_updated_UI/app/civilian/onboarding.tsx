      ...
      <ScrollView contentContainerStyle={styles.content} showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.missionCard}>
          ...
          <View style={styles.missionTextContainer}>
            <Text style={styles.missionTitle}>LANDSLIDE EARLY WARNING & SAFE RESPONSE</Text>
            <Text style={styles.missionDesc}>
              Predicts slope failures, computes dynamic safe routes bypassing mountain highway blockades, and transmits ground observations to response teams.
            </Text>
          </View>
        </View>
          ...
          <View style={styles.permHeader}>
            ...
            <View style={styles.permTextContainer}>
              ...
              <Text style={styles.permDesc}>
                Required to compute dynamic safest mountain evacuation paths away from active rockfall & landslide hazard zones.
              </Text>
            </View>
          </View>
        ...
        <View style={styles.permissionCard}>
          <View style={styles.permHeader}>
            ...
            <View style={styles.permTextContainer}>
              <Text style={styles.permTitle}>Early Warning Broadcasts</Text>
              <Text style={styles.permDesc}>
                Receive life-saving landslide warnings and road advisories issued by MDoNER, Sikkim SDMA & BRO.
              </Text>
            </View>
          </View>
