...
import { FieldReportType, HazardSeverity } from '../../types';
...
const SEVERITIES: { level: HazardSeverity; label: string; color: string }[] = [
    ...
    <View style={styles.card}>
      ...
      <View style={styles.gpsRow}>
        ...
        <Text style={styles.gpsText}>
          GPS Locked: {profile?.currentLocation?.latitude ? profile.currentLocation.latitude.toFixed(4) : '27.2340'}° N,{' '}
          {profile?.currentLocation?.longitude ? profile.currentLocation.longitude.toFixed(4) : '88.5120'}° E (±4m elevation accuracy)
        </Text>
      </View>
          ...
          <View style={styles.photoPreviewRow}>
            ...
            <View style={styles.photoMeta}>
              ...
              <Text style={styles.photoDetails}>
                GPS Stamped: {profile?.currentLocation?.latitude ? profile.currentLocation.latitude.toFixed(4) : '27.2340'}°N, {profile?.currentLocation?.longitude ? profile.currentLocation.longitude.toFixed(4) : '88.5120'}°E
              </Text>
            </View>
